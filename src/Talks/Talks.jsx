...
//         {/* <Talknav/> */}
//         <a className="pressbtn" href="#press">
//           Press & Newsletters
//         </a>
//       </div>
//       <div></div>
...
//         <p className="talk-p">
//           Alluri, V. (2023). The Naturalistic Paradigm: An Approach To Studying
//           Individual Variability In Neural Underpinnings Of Music Perception.
...
//           International Symposium on Frontiers of Research in Speech and Music.
//           Pune, India.
//         </p>
//       </div>
...
//         <p className="talk-p">
//           Alluri, V. (2019). Music as a mirror of the self. Indian Institute of
...
//         <img className="talk-iconfrsm" src={iitb} />
//         <p className="talk-p">
//           Alluri, V. (2018). Decoding Brain States using Music. Indian Institute
...
//         <img className="talk-iconfrsm" src={frsm} />
//         <p className="talk-p">
//           Alluri, V. (2017). Music Processing During Naturalistic Listening and
//           the Effect of Musical Expertise. At the 23rd Frontiers of Research in
//           Speech and Music Conference, Rourkela, India
//         </p>
//       </div>
  ...
  return (
    <div>
      ...
      <div id="keynotes" className="keynotes-section">
        <h1 className="section-title">Keynotes & Invited Talks</h1>
